The .ipynb file calculates position of NEOs (Near Earth Objects) relative to Earth and each other and finally, calculate probability of their orbital close approaches.
